          ...
          <section className="self-stretch flex flex-row items-start justify-start py-0 px-6 box-border max-w-full text-center text-sm text-others-white font-body-small-medium">
            <div className="flex-1 flex flex-row items-start justify-start gap-[24px] max-w-full mq950:flex-wrap">
              <div className="w-[300px] rounded-2xl bg-others-white flex flex-col items-end justify-start pt-1 pb-[30px] pr-6 pl-2.5 box-border gap-[24px] min-w-[300px] mq950:flex-1">
                ...
                <h2 className="m-0 w-[252px] relative text-xl leading-[140%] font-bold font-inherit text-greyscale-900 inline-block mq450:text-base mq450:leading-[22px]">
                  Pristia Candra
                </h2>
                ...
                <div className="w-[252px] flex flex-col items-start justify-start gap-[16px] text-left text-xs text-greyscale-600">
                  ...
                  <div className="self-stretch flex flex-row items-center justify-start gap-[10px]">
                    ...
                    <img
                      ...
                      loading="lazy"
                      alt=""
                      src="/chevronright-22.svg"
                    />
                  </div>
                </div>
              </div>
              <div className="flex-1 rounded-2xl bg-others-white flex flex-col items-center justify-start p-6 box-border gap-[24px] min-w-[512px] max-w-full text-greyscale-900 mq700:pt-5 mq700:pb-5 mq700:box-border mq700:min-w-full">
                ...
                <div className="self-stretch rounded-2xl bg-others-white box-border flex flex-col items-start justify-start py-[22px] px-[23px] gap-[16px] max-w-full text-left text-lg border-[1px] border-solid border-greyscale-200 mq700:pt-5 mq700:pb-5 mq700:box-border">
                  <div className="self-stretch flex flex-row items-center justify-start gap-[10px] max-w-full mq700:flex-wrap">
                    <div className="flex-1 flex flex-row items-center justify-start min-w-[44px] max-w-full">
                      <h3 className="m-0 relative text-inherit leading-[150%] font-semibold font-inherit inline-block min-w-[44px]">
                        Docs
                      </h3>
                    </div>
                    <img
