const Remarque2 = () => {
    return (
      <div className="w-full relative bg-greyscale-50 overflow-hidden flex flex-row items-start justify-start leading-[normal] tracking-[normal] text-left text-base text-others-white font-body-small-medium mq925:pl-5 mq925:pr-5 mq925:box-border">
        ...
        <main className="flex-1 flex flex-col items-start justify-start gap-[32px] max-w-[calc(100%_-_280px)] text-left text-5xl text-greyscale-900 font-body-small-medium mq700:gap-[16px] mq925:max-w-full">
          <header className="self-stretch bg-others-white flex flex-row items-start justify-end pt-8 px-8 pb-[30px] gap-[30px] top-[0] z-[99] sticky border-b-[1px] border-solid border-greyscale-300">
          ...
          <div className="self-stretch flex flex-row items-center justify-between py-0 px-6 box-border max-w-full gap-[0px] [row-gap:20px]">
            ...
            <div className="w-[1088px] flex flex-col items-start justify-start max-w-[calc(100%_-_24px)]">
              <div className="self-stretch flex flex-row flex-wrap items-center justify-start py-0 px-6 box-border gap-[20px] max-w-full">
                <div className="flex-1 flex flex-col items-start justify-start gap-[8px] min-w-[345px] max-w-full mq700:min-w-full">
                ...
                <button className="cursor-pointer [border:none] p-0 bg-[transparent] flex flex-row items-start justify-start">
                  <div className="rounded-3xs bg-greyscale-900 overflow-x-auto flex flex-row items-center justify-center py-4 px-6 gap-[7px]">
                    <img
                ...
                <div className="w-[252px] flex flex-col items-start justify-start gap-[16px] text-left text-xs text-greyscale-600">
                  ...
                  <div className="self-stretch flex flex-row items-center justify-start gap-[10px]">
                    ...
                    <img
                      ...
                      loading="lazy"
                      alt=""
                      src="/chevronright-23.svg"
                    />
                  </div>
                </div>
              </div>
              <div className="flex-1 rounded-2xl bg-others-white flex flex-col items-center justify-start pt-0 pb-6 pr-[19px] pl-6 box-border relative gap-[24px] min-w-[512px] min-h-[663px] max-w-full text-left text-greyscale-900 mq700:min-w-full">
                <div className="self-stretch overflow-x-auto flex flex-row items-start justify-start py-0 pr-[150px] pl-0 text-center border-b-[1px] border-solid border-greyscale-200 mq925:pr-[75px] mq925:box-border mq450:pr-5 mq450:box-border">
                ...
                <div className="self-stretch rounded-2xl bg-others-white box-border flex flex-col items-start justify-start py-[22px] px-[23px] gap-[16px] max-w-full text-lg border-[1px] border-solid border-greyscale-200 mq700:pt-5 mq700:pb-5 mq700:box-border">
                ...
                <div className="w-[200px] !m-[0] absolute top-[-24px] right-[19px] shadow-[5px_5px_50px_rgba(26,_32,_44,_0.06)] rounded-xl bg-others-white flex flex-col items-start justify-center p-4 box-border gap-[16px] z-[1] text-base">
                  <b className="self-stretch relative tracking-[0.3px] leading-[150%]">
                    Tarification
                  </b>
